...
This repository contains a recruiter-friendly, one-page portfolio website for an industrial designer. The site is built with plain HTML, CSS, and JavaScript, and it follows modern UI/UX conventions for clarity, accessibility, and professional presentation.
...
2. Review the hero, about, featured work, skills, experience, and contact sections.
